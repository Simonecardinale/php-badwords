<?php
    ...
    $lunghezzaOriginale = strlen($string);
    $lunghezzaCensurata = strlen($badword);

?>

<h1><?php echo $string;?></h1>
<h2><?php echo $badword;?></h2>
<h2>La lunghezza della frase originale è <?php echo $lunghezzaOriginale;?></h2>
<h2>La lunghezza della frase con la censura è <?php echo $lunghezzaCensurata;?></h2>
